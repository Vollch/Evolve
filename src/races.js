...
import { vBind, clearElement, removeFromQueue, removeFromRQueue, calc_mastery, getEaster, getHalloween, gameLoop } from './functions.js';
...
export var traits, traitExtra, races, biomes, planetTraits, genusVars;
...
export function altRace(race,set){
    ...
    switch (race){
        ...
        case 'wolven':
            {
                if (getEaster().active || (global.race['hrt'] && global.race.hrt === race)){
                    if (set){global.race['hrt'] = race;}
                    return true;
                }
                return false;
        ...
        case 'junker':
            {
                if (getHalloween().active || (global.race['hrt'] && global.race.hrt === race)){
                    if (set){global.race['hrt'] = race;}
                    return true;
                }
                return false;
